...
<div class="cf" >
    <div class="fl">
        <a class="btn" href="<?php echo url('index/addCarousel'); ?>">添 加</a>
    </div>
</div>
...
<div class="data-table">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo !empty($item['big_img'])?'<img src="'.$item['big_img'].'" width="200"/>' : ''; ?></td>
            <td><?php echo !empty($item['img'])?'<img src="'.$item['img'].'" width="200"/>' : ''; ?></td>
            <td><?php echo !empty($item['mob_img'])?'<img src="'.$item['mob_img'].'" width="200"/>' : ''; ?></td>
            <td><?php echo $item['sort']; ?></td>
            <td><?php echo !empty($item['target']) && $item['target']==1?'是' : '否'; ?></td>
            ...
            <td>
                <a href="<?php echo url('index/editCarousel',['id'=>$item['_id']]); ?>">编辑</a>
                <a href="<?php echo url('index/delCarousel',['id'=>$item['_id']]); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
