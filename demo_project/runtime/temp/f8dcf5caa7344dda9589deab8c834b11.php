...
<div class="cf" >
    <div class="fl">
        <a class="btn" href="<?php echo url('index/addFeature'); ?>">添 加</a>
    </div>
</div>
...
<div class="data-table">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo !empty($item['img'])?'<img src="'.$item['img'].'" width="300"/>' : ''; ?></td>
            <td><?php echo !empty($item['big_img'])?'<img src="'.$item['big_img'].'" width="300"/>' : ''; ?></td>
            ...
            <td>
                <a href="<?php echo url('index/editFeature',['id'=>$item['_id']]); ?>">编辑</a>
                <a href="<?php echo url('index/delFeature',['id'=>$item['_id']]); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
