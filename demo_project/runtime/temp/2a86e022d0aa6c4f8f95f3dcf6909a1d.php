...
<div class="cf" >
    <div class="fl">
        <a class="btn" href="<?php echo url('Page/add'); ?>">添 加</a>
    </div>
</div>
...
<div class="data-table">
    <table class="">
        ...
        <tr>
            ...
            <td style="display:none"><a href="<?php echo url('index/page/index',['tag'=>$item['tag']],true,true); ?>" target="_blank"><?php echo url('index/page/index',['tag'=>$item['tag']],true,true); ?></a></td>
            ...
            <td>
                <a href="<?php echo url('Page/edit',['id'=>$item['_id']]); ?>">编辑</a>
                <a href="<?php echo url('Page/del',['id'=>$item['_id']]); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
