...
<div class="cf" >
    <div class="fl">
        <a class="btn" href="<?php echo url('News/addCategory'); ?>">添 加</a>
    </div>
</div>
...
<div class="data-table">
    <table class="">
        ...
        <tr>
            ...
            <td style="display:none"><a href="<?php echo url('index/News/index',['cid'=>$item['_id']],true,true); ?>" target="_target"><?php echo url('index/News/index',['cid'=>$item['_id']],true,true); ?></a></td>
            <td><?php echo getDateFromTimestamp($item['updateAt']); ?></td>
            <td>
                <a href="<?php echo url('News/editCategory',['id'=>$item['_id']]); ?>">编辑</a>
                <a href="<?php echo url('News/delCategory',['id'=>$item['_id']]); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
