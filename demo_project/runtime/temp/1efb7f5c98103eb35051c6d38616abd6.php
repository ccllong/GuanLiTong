...
<div class="cf" >
    <div class="fl">
        <a class="btn" href="<?php echo url('News/addNews'); ?>">添 加</a>
    </div>
</div>
...
<div class="data-table">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo !empty($cate_list[$item['cate_id']])?$cate_list[$item['cate_id']] : ''; ?></td>
            <td style="display:none"><a href="<?php echo url('index/News/index',['cid'=>$item['cate_id'],'id'=>$item['_id']],true,true); ?>" target="_blank"><?php echo url('index/News/index',['cid'=>$item['cate_id'],'id'=>$item['_id']],true,true); ?></a></td>
            <td><?php echo !empty($item['sort'])?$item['sort'] : '0'; ?></td>
            ...
            <td><?php echo getDateFromTimestamp($item['createAt']); ?></td>
            <td>
                <a href="<?php echo url('News/editNews',['id'=>$item['_id']]); ?>">编辑</a>
                <a href="<?php echo url('News/delNews',['id'=>$item['_id']]); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
